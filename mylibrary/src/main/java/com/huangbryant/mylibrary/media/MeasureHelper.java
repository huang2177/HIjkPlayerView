...
public final class MeasureHelper {
    ...
    // 视频显示模式
    private int mCurrentAspectRatio = HIRenderView.AR_ASPECT_FIT_PARENT;
    ...
    public void doMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mCurrentAspectRatio == HIRenderView.AR_MATCH_PARENT) {
            ...
            if (widthSpecMode == View.MeasureSpec.AT_MOST || heightSpecMode == View.MeasureSpec.AT_MOST) {
                ...
                switch (mCurrentAspectRatio) {
                    case HIRenderView.AR_16_9_FIT_PARENT:
                        // 16：9
                        displayAspectRatio = 16.0f / 9.0f;
                        if (mVideoRotationDegree == 90 || mVideoRotationDegree == 270)
                            displayAspectRatio = 1.0f / displayAspectRatio;
                        break;
                    case HIRenderView.AR_4_3_FIT_PARENT:
                        // 4：3
                        displayAspectRatio = 4.0f / 3.0f;
                        if (mVideoRotationDegree == 90 || mVideoRotationDegree == 270)
                            displayAspectRatio = 1.0f / displayAspectRatio;
                        break;
                    case HIRenderView.AR_ASPECT_FIT_PARENT:
                    case HIRenderView.AR_ASPECT_FILL_PARENT:
                    case HIRenderView.AR_ASPECT_WRAP_CONTENT:
                    default:
                        // 按视频来源宽高比
                ...
                switch (mCurrentAspectRatio) {
                    ...
                    case HIRenderView.AR_4_3_FIT_PARENT:
                        ...
                        break;
                    case HIRenderView.AR_ASPECT_FILL_PARENT: // 填充满控件模式
                        if (shouldBeWider) {
