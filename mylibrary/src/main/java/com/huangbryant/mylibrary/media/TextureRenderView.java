...
public class TextureRenderView extends TextureView implements HIRenderView {
    ...
    public HIRenderView.ISurfaceHolder getSurfaceHolder() {
        return new InternalSurfaceHolder(this, mSurfaceCallback.mSurfaceTexture, mSurfaceCallback);
    }

    private static final class InternalSurfaceHolder implements HIRenderView.ISurfaceHolder {
        ...
        @NonNull
        @Override
        public HIRenderView getRenderView() {
            return mTextureView;
        }
