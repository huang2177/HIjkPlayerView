...
import com.huangbryant.mylibrary.R;
import com.huangbryant.mylibrary.danmaku.BaseDanmakuConverter;
import com.huangbryant.mylibrary.danmaku.BiliDanmukuParser;
import com.huangbryant.mylibrary.danmaku.OnDanmakuListener;
import com.huangbryant.mylibrary.utils.AnimHelper;
import com.huangbryant.mylibrary.utils.MotionEventUtils;
import com.huangbryant.mylibrary.utils.NavUtils;
import com.huangbryant.mylibrary.utils.NetWorkUtils;
import com.huangbryant.mylibrary.utils.SDCardUtils;
import com.huangbryant.mylibrary.utils.SoftInputUtils;
import com.huangbryant.mylibrary.utils.StringUtils;
import com.huangbryant.mylibrary.utils.WindowUtils;
import com.huangbryant.mylibrary.widgets.MarqueeTextView;
import com.huangbryant.mylibrary.widgets.ShareDialog;
...
import static com.huangbryant.mylibrary.utils.StringUtils.generateTime;


/**
 * Created by long on 2016/10/24.
 */
public class HIjkPlayerView extends FrameLayout implements View.OnClickListener {
    ...
    // 原生的IjkPlayer
    private HIjkVideoView mVideoView;
    ...
    public HIjkPlayerView(Context context) {
        this(context, null);
    }

    public HIjkPlayerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        _initView(context);
    }
...
//        }
        ...
        mVideoView = (HIjkVideoView) findViewById(R.id.video_view);
        ...
        mAspectRatioOptions.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.aspect_fit_parent) {
                    mVideoView.setAspectRatio(HIRenderView.AR_ASPECT_FIT_PARENT);
                } else if (checkedId == R.id.aspect_fit_screen) {
                    mVideoView.setAspectRatio(HIRenderView.AR_ASPECT_FILL_PARENT);
                } else if (checkedId == R.id.aspect_16_and_9) {
                    mVideoView.setAspectRatio(HIRenderView.AR_16_9_FIT_PARENT);
                } else if (checkedId == R.id.aspect_4_and_3) {
                    mVideoView.setAspectRatio(HIRenderView.AR_4_3_FIT_PARENT);
                }
    ...
    public void onResume() {
        if (mIsScreenLocked) {
            ...
            mVideoView.setRender(HIjkVideoView.RENDER_TEXTURE_VIEW);
     ...
     * @return
     */
    public HIjkPlayerView switchVideoPath(String url) {
     ...
     * @return
     */
    public HIjkPlayerView switchVideoPath(Uri uri) {
     ...
     * @return
     */
    public HIjkPlayerView setVideoPath(String url) {
     ...
     * @return
     */
    public HIjkPlayerView setVideoPath(Uri uri) {
     ...
     * @param title
     */
    public HIjkPlayerView setTitle(String title) {
     ...
     * 设置只显示全屏状态
     */
    public HIjkPlayerView alwaysFullScreen() {
...
//        mPlayerThumb.setVisibility(View.GONE);
     ...
     * 使能视频翻转
     */
    public HIjkPlayerView enableOrientation() {
...
//        mVideoView.setOnCompletionListener(l);
     ...
     */
    public HIjkPlayerView setDanmakuListener(OnDanmakuListener danmakuListener) {
     ...
     * @return
     */
    public HIjkPlayerView switchVideoSource(String mediaSmooth, String mediaMedium, String mediaHigh, String mediaSuper, String mediaBd) {
        reset();
     ...
     * @param mediaBd     1080P
     */
    public HIjkPlayerView setVideoSource(String mediaSmooth, String mediaMedium, String mediaHigh, String mediaSuper, String mediaBd) {
     ...
     * @return
     */
    public HIjkPlayerView setMediaQuality(@MediaQuality int quality) {
     ...
     */
    public HIjkPlayerView setSkipTip(int targetPosition) {
...
//            mDanmakuContext.setDanmakuSync(new VideoDanmakuSync(this));
     ...
     * @return
     */
    public HIjkPlayerView enableDanmaku() {
     ...
     * @return
     */
    public HIjkPlayerView enableDanmaku(boolean isEnable) {
     ...
     * @return
     */
    public HIjkPlayerView setDanmakuSource(InputStream stream) {
        if (stream == null) {
            return this;
        }
        if (!mIsEnableDanmaku) {
     ...
     * @return
     */
    public HIjkPlayerView setDanmakuSource(String uri) {
     ...
     * @return
     */
    public HIjkPlayerView setDanmakuCustomParser(BaseDanmakuParser parser, ILoader loader, BaseDanmakuConverter converter) {
     ...
     * @return
     */
    public HIjkPlayerView showOrHideDanmaku(boolean isShow) {
        if (isShow) {
    ...
    private void _showShareDialog(Bitmap bitmap) {
        ...
        //mShareDialog.show(mAttachActivity.getFragmentManager(), "share");
    }
     ...
     * @return
     */
    public HIjkPlayerView setDialogClickListener(ShareDialog.OnDialogClickListener dialogClickListener) {
     ...
     * @param path
     */
    public HIjkPlayerView setSaveDir(String path) {
        _createSaveDir(path);
        return this;
    }
